...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $password = password_hash($_POST['password'], PASSWORD_DEFAULT); // plain text password

    // Optional: check if admin ID already exists
    ...
    if ($check_result->num_rows > 0) {
        ...
        $sql = "INSERT INTO admin (admin_id, pass) VALUES ('$admin_id', '$password')";
